...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ga(e,t,n){let r=new Float32Array(ja),i=new U(0,1,0);return new Ei({name:`SphericalGaussianBlur`,defines:{n:ja,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ja(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qa(){return new Ei({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ja(),fragmentShader:`
	...
	`}var Ya=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new di(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,svgExportable:!0},{id:`scanlines`,label:`Scanlines CRT`,category:`retro`,params:{intensity:{type:`float`,label:`Intensidad`,min:0,max:1,default:.3,step:.02},speed:{type:`float`,label:`Scroll`,min:0,max:10,default:0,step:.5},spacing:{type:`select`,label:`Espaciado`,options:[2,3,4,6,8,10,12],default:4}},renderer:`glsl`,vertexShader:Xc,fragmentShader:`uniform sampler2D tDiffuse;
...
`,svgExportable:!0},{id:`floyd-steinberg`,label:`Dither Floyd-Steinberg`,category:`dither`,params:{threshold:{type:`float`,label:`Contraste`,min:0,max:1,default:.5,step:.01},pixelSize:{type:`select`,label:`Pixelado`,options:[1,2,4,8,12,16],default:2},palette:{type:`palette`,label:`Paleta`,default:[`#000000`,`#ffffff`],minColors:2,maxColors:8}},renderer:`cpu`,svgExportable:!0,processFn:(e,t)=>{let{w:n,h:r,data:i}={w:e.width,h:e.height,data:e.data},a=t.palette||[`#000000`,`#ffffff`],o=e=>(e=e.replace(`#`,``),e.length===3&&(e=e.split(``).map(e=>e+e).join(``)),[parseInt(e.substring(0,2),16)/255,parseInt(e.substring(2,4),16)/255,parseInt(e.substring(4,6),16)/255]),s=a.map(e=>o(e)),c=s.length,l=s.map(e=>e[0]*.299+e[1]*.587+e[2]*.114),u=new Float32Array(n*r);for(let e=0;e<n*r;e++){let t=e*4;u[e]=i[t]*.299+i[t+1]*.587+i[t+2]*.114}for(let e=0;e<r;e++)for(let t=0;t<n;t++){let a=t+e*n,o=u[a],d=0,f=1/0;for(let e=0;e<c;e++){let t=Math.abs(o-l[e]*255);t<f&&(f=t,d=e)}let p=o-l[d]*255;t+1<n&&(u[t+1+e*n]+=7/16*p),t-1>=0&&e+1<r&&(u[t-1+(e+1)*n]+=3/16*p),e+1<r&&(u[t+(e+1)*n]+=5/16*p),t+1<n&&e+1<r&&(u[t+1+(e+1)*n]+=1/16*p);let m=a*4,h=s[d];i[m]=Math.round(h[0]*255),i[m+1]=Math.round(h[1]*255),i[m+2]=Math.round(h[2]*255),i[m+3]=255}return e}},{id:`halftone`,label:`Halftone`,category:`print`,params:{dotSize:{type:`int`,label:`Tamaño Punto`,min:2,max:20,default:6,step:1},contrast:{type:`float`,label:`Contraste`,min:0,max:1,default:.5,step:.02},speed:{type:`float`,label:`Velocidad`,min:0,max:5,default:.5,step:.1},angle:{type:`float`,label:`Ángulo Trama`,min:0,max:6.28,default:.78,step:.05},palette:{type:`palette`,label:`Paleta`,default:[`#000000`,`#ffffff`],minColors:2,maxColors:8}},renderer:`glsl`,vertexShader:Xc,fragmentShader:`uniform sampler2D tDiffuse;
uniform vec2 uResolution;
...
`,svgExportable:!0},{id:`risograph`,label:`Risograph`,category:`print`,params:{offsetX:{type:`float`,label:`Offset X`,min:-20,max:20,default:3,step:.5},offsetY:{type:`float`,label:`Offset Y`,min:-20,max:20,default:-2,step:.5},grain:{type:`float`,label:`Grano Papel`,min:0,max:1,default:.3,step:.02},hue:{type:`float`,label:`Tono Tinta`,min:0,max:1,default:.58,step:.01},saturation:{type:`float`,label:`Saturación`,min:0,max:1,default:.7,step:.01},split:{type:`float`,label:`División Tonal`,min:.2,max:.8,default:.45,step:.02}},renderer:`glsl`,vertexShader:Xc,fragmentShader:`uniform sampler2D tDiffuse;
uniform vec2 uResolution;
uniform float uTime;
...
`,svgExportable:!1},{id:`glitch`,label:`Glitch`,category:`destroy`,params:{intensity:{type:`float`,label:`Intensidad`,min:0,max:1,default:.3,step:.02},blockSize:{type:`float`,label:`Bloques`,min:.01,max:.2,default:.05,step:.005},rgbShift:{type:`float`,label:`Shift RGB`,min:0,max:.05,default:.01,step:.001},speed:{type:`float`,label:`Velocidad`,min:.5,max:10,default:3,step:.5},scanDistortion:{type:`float`,label:`Distorsión VHS`,min:0,max:1,default:.2,step:.02}},renderer:`glsl`,vertexShader:Xc,fragmentShader:`uniform sampler2D tDiffuse;
uniform vec2 uResolution;
uniform float uTime;
...
`,svgExportable:!1},{id:`posterize`,label:`Posterización`,category:`tone`,params:{levels:{type:`int`,label:`Niveles`,min:2,max:16,default:4,step:1},hue:{type:`float`,label:`Tono (Hue)`,min:0,max:1,default:0,step:.01},saturation:{type:`float`,label:`Saturación`,min:0,max:1,default:0,step:.01}},renderer:`glsl`,vertexShader:Xc,fragmentShader:`uniform sampler2D tDiffuse;
uniform float uTime;
...
`,svgExportable:!0},{id:`kaleidoscope`,label:`Caleidoscopio`,category:`transform`,params:{segments:{type:`int`,label:`Segmentos`,min:2,max:24,default:6,step:1},zoom:{type:`float`,label:`Zoom`,min:.5,max:3,default:1,step:.05},rotation:{type:`float`,label:`Rotación`,min:0,max:6.28,default:0,step:.05},hue:{type:`float`,label:`Tono (Hue)`,min:0,max:1,default:0,step:.01},saturation:{type:`float`,label:`Saturación`,min:0,max:1,default:0,step:.01}},renderer:`glsl`,vertexShader:Xc,fragmentShader:`uniform sampler2D tDiffuse;
uniform float uTime;
...
`,svgExportable:!1},{id:`feedback`,label:`Feedback (Delay)`,category:`feedback`,params:{feedback:{type:`float`,label:`Feedback`,min:0,max:1,default:.75,step:.01},decay:{type:`float`,label:`Decaimiento`,min:.5,max:1,default:.95,step:.005},mix:{type:`float`,label:`Mezcla`,min:0,max:1,default:.6,step:.01},hue:{type:`float`,label:`Tono`,min:0,max:1,default:0,step:.005},saturation:{type:`float`,label:`Saturación`,min:0,max:1,default:0,step:.01}},renderer:`glsl`,vertexShader:Xc,fragmentShader:`uniform sampler2D tDiffuse;
...
`,svgExportable:!1},{id:`atkinson-dither`,label:`Dither Atkinson`,category:`dither`,params:{threshold:{type:`float`,label:`Contraste`,min:0,max:1,default:.5,step:.01},pixelSize:{type:`select`,label:`Pixelado`,options:[1,2,4,8,12,16],default:2},palette:{type:`palette`,label:`Paleta`,default:[`#000000`,`#ffffff`],minColors:2,maxColors:8}},renderer:`cpu`,svgExportable:!0,processFn:(e,t)=>{let n=e.width,r=e.height,i=e.data,a=t.palette||[`#000000`,`#ffffff`],o=e=>(e=e.replace(`#`,``),e.length===3&&(e=e.split(``).map(e=>e+e).join(``)),[parseInt(e.substring(0,2),16)/255,parseInt(e.substring(2,4),16)/255,parseInt(e.substring(4,6),16)/255]),s=a.map(e=>o(e)),c=s.length,l=s.map(e=>e[0]*.299+e[1]*.587+e[2]*.114),u=new Float32Array(n*r);for(let e=0;e<n*r;e++){let t=e*4;u[e]=i[t]*.299+i[t+1]*.587+i[t+2]*.114}for(let e=0;e<r;e++)for(let t=0;t<n;t++){let a=t+e*n,o=u[a],d=0,f=1/0;for(let e=0;e<c;e++){let t=Math.abs(o-l[e]*255);t<f&&(f=t,d=e)}let p=(o-l[d]*255)*(1/8);t+1<n&&(u[t+1+e*n]+=p),t+2<n&&(u[t+2+e*n]+=p),t-1>=0&&e+1<r&&(u[t-1+(e+1)*n]+=p),e+1<r&&(u[t+(e+1)*n]+=p),t+1<n&&e+1<r&&(u[t+1+(e+1)*n]+=p),e+2<r&&(u[t+(e+2)*n]+=p);let m=a*4,h=s[d];i[m]=Math.round(h[0]*255),i[m+1]=Math.round(h[1]*255),i[m+2]=Math.round(h[2]*255),i[m+3]=255}return e}},{id:`stucki`,label:`Dither Stucki`,category:`dither`,params:{threshold:{type:`float`,label:`Contraste`,min:0,max:1,default:.5,step:.01},pixelSize:{type:`select`,label:`Pixelado`,options:[1,2,4,8,12,16],default:2},palette:{type:`palette`,label:`Paleta`,default:[`#000000`,`#ffffff`],minColors:2,maxColors:8}},renderer:`cpu`,svgExportable:!0,processFn:(e,t)=>{let n=e.width,r=e.height,i=e.data,a=t.palette||[`#000000`,`#ffffff`],o=e=>(e=e.replace(`#`,``),e.length===3&&(e=e.split(``).map(e=>e+e).join(``)),[parseInt(e.substring(0,2),16)/255,parseInt(e.substring(2,4),16)/255,parseInt(e.substring(4,6),16)/255]),s=a.map(e=>o(e)),c=s.length,l=s.map(e=>e[0]*.299+e[1]*.587+e[2]*.114),u=new Float32Array(n*r);for(let e=0;e<n*r;e++){let t=e*4;u[e]=i[t]*.299+i[t+1]*.587+i[t+2]*.114}for(let e=0;e<r;e++)for(let t=0;t<n;t++){let a=t+e*n,o=u[a],d=0,f=1/0;for(let e=0;e<c;e++){let t=Math.abs(o-l[e]*255);t<f&&(f=t,d=e)}let p=o-l[d]*255;t+1<n&&(u[t+1+e*n]+=8/42*p),t+2<n&&(u[t+2+e*n]+=4/42*p),t-2>=0&&e+1<r&&(u[t-2+(e+1)*n]+=2/42*p),t-1>=0&&e+1<r&&(u[t-1+(e+1)*n]+=4/42*p),e+1<r&&(u[t+(e+1)*n]+=8/42*p),t+1<n&&e+1<r&&(u[t+1+(e+1)*n]+=4/42*p),t+2<n&&e+1<r&&(u[t+2+(e+1)*n]+=2/42*p),t-2>=0&&e+2<r&&(u[t-2+(e+2)*n]+=1/42*p),t-1>=0&&e+2<r&&(u[t-1+(e+2)*n]+=2/42*p),e+2<r&&(u[t+(e+2)*n]+=4/42*p),t+1<n&&e+2<r&&(u[t+1+(e+2)*n]+=2/42*p),t+2<n&&e+2<r&&(u[t+2+(e+2)*n]+=1/42*p);let m=a*4,h=s[d];i[m]=Math.round(h[0]*255),i[m+1]=Math.round(h[1]*255),i[m+2]=Math.round(h[2]*255),i[m+3]=255}return e}},{id:`jarvis`,label:`Dither Jarvis-Judice-Ninke`,category:`dither`,params:{threshold:{type:`float`,label:`Contraste`,min:0,max:1,default:.5,step:.01},pixelSize:{type:`select`,label:`Pixelado`,options:[1,2,4,8,12,16],default:2},palette:{type:`palette`,label:`Paleta`,default:[`#000000`,`#ffffff`],minColors:2,maxColors:8}},renderer:`cpu`,svgExportable:!0,processFn:(e,t)=>{let n=e.width,r=e.height,i=e.data,a=t.palette||[`#000000`,`#ffffff`],o=e=>(e=e.replace(`#`,``),e.length===3&&(e=e.split(``).map(e=>e+e).join(``)),[parseInt(e.substring(0,2),16)/255,parseInt(e.substring(2,4),16)/255,parseInt(e.substring(4,6),16)/255]),s=a.map(e=>o(e)),c=s.length,l=s.map(e=>e[0]*.299+e[1]*.587+e[2]*.114),u=new Float32Array(n*r);for(let e=0;e<n*r;e++){let t=e*4;u[e]=i[t]*.299+i[t+1]*.587+i[t+2]*.114}for(let e=0;e<r;e++)for(let t=0;t<n;t++){let a=t+e*n,o=u[a],d=0,f=1/0;for(let e=0;e<c;e++){let t=Math.abs(o-l[e]*255);t<f&&(f=t,d=e)}let p=o-l[d]*255;t+1<n&&(u[t+1+e*n]+=7/48*p),t+2<n&&(u[t+2+e*n]+=5/48*p),t-2>=0&&e+1<r&&(u[t-2+(e+1)*n]+=3/48*p),t-1>=0&&e+1<r&&(u[t-1+(e+1)*n]+=5/48*p),e+1<r&&(u[t+(e+1)*n]+=7/48*p),t+1<n&&e+1<r&&(u[t+1+(e+1)*n]+=5/48*p),t+2<n&&e+1<r&&(u[t+2+(e+1)*n]+=3/48*p),t-2>=0&&e+2<r&&(u[t-2+(e+2)*n]+=1/48*p),t-1>=0&&e+2<r&&(u[t-1+(e+2)*n]+=3/48*p),e+2<r&&(u[t+(e+2)*n]+=5/48*p),t+1<n&&e+2<r&&(u[t+1+(e+2)*n]+=3/48*p),t+2<n&&e+2<r&&(u[t+2+(e+2)*n]+=1/48*p);let m=a*4,h=s[d];i[m]=Math.round(h[0]*255),i[m+1]=Math.round(h[1]*255),i[m+2]=Math.round(h[2]*255),i[m+3]=255}return e}},{id:`clustered-dot`,label:`Clustered Dot`,category:`dither`,params:{dotSize:{type:`int`,label:`Trama`,min:2,max:20,default:6,step:1},contrast:{type:`float`,label:`Contraste`,min:0,max:1,default:.5,step:.02},speed:{type:`float`,label:`Velocidad`,min:0,max:5,default:.5,step:.1},angle:{type:`float`,label:`Ángulo`,min:0,max:6.28,default:0,step:.05},palette:{type:`palette`,label:`Paleta`,default:[`#000000`,`#ffffff`],minColors:2,maxColors:8}},renderer:`glsl`,vertexShader:Xc,fragmentShader:`uniform sampler2D tDiffuse;
uniform vec2 uResolution;
uniform float uDotSize;
uniform float uContrast;
uniform float uAngle;
...
`,svgExportable:!0},{id:`crosshatch`,label:`Crosshatch`,category:`dither`,params:{scale:{type:`float`,label:`Escala`,min:2,max:40,default:12,step:1},contrast:{type:`float`,label:`Contraste`,min:0,max:1,default:.5,step:.02},speed:{type:`float`,label:`Velocidad`,min:0,max:5,default:.5,step:.1},angle:{type:`float`,label:`Ángulo`,min:0,max:6.28,default:0,step:.05},palette:{type:`palette`,label:`Paleta`,default:[`#000000`,`#ffffff`],minColors:2,maxColors:8}},renderer:`glsl`,vertexShader:Xc,fragmentShader:`uniform sampler2D tDiffuse;
uniform vec2 uResolution;
...
`,svgExportable:!0},{id:`brick-dither`,label:`Ladrillos (Brick)`,category:`dither`,params:{brickSize:{type:`float`,label:`Tamaño`,min:2,max:60,default:20,step:1},contrast:{type:`float`,label:`Contraste`,min:0,max:1,default:.5,step:.02},speed:{type:`float`,label:`Velocidad`,min:0,max:5,default:.5,step:.1},angle:{type:`float`,label:`Ángulo`,min:0,max:6.28,default:0,step:.05},palette:{type:`palette`,label:`Paleta`,default:[`#000000`,`#ffffff`],minColors:2,maxColors:8}},renderer:`glsl`,vertexShader:Xc,fragmentShader:`uniform sampler2D tDiffuse;
uniform vec2 uResolution;
...
`,svgExportable:!0}],Qc=e=>Zc.find(t=>t.id===e),$c=e=>{let t={};return!e||!e.params||Object.keys(e.params).forEach(n=>{t[n]=e.params[n].default}),t};function el(){let e=new URLSearchParams(window.location.search).has(`output`),t=(0,_.useRef)(null),n=(0,_.useRef)(null),r=(0,_.useRef)(null),i=(0,_.useRef)(null),a=(0,_.useRef)(null);t.current||=new Rc,n.current||=new Bc,r.current||=new Hc;let o=t.current,s=n.current,c=r.current,[l,u]=(0,_.useState)(()=>Zc.map(e=>e.id)),[d,f]=(0,_.useState)(()=>{let e={};return Zc.forEach(t=>{e[t.id]={enabled:t.id===`bayer-dither`,activeParams:$c(t)}}),e}),[p,m]=(0,_.useState)(()=>({})),[h,g]=(0,_.useState)(`procedural`),[v,y]=(0,_.useState)(`Procedural: Barras de Prueba`),[b,x]=(0,_.useState)(!1),[S,C]=(0,_.useState)(!1),[w,T]=(0,_.useState)(null),[E,D]=(0,_.useState)(!0),O=(0,_.useRef)(null),k=(0,_.useRef)(null),[A,j]=(0,_.useState)(!1),ee=(0,_.useRef)(0),te=(0,_.useRef)(null),[M,ne]=(0,_.useState)(!1),[N,P]=(0,_.useState)([`#000000`,`#ffffff`]),re=(e,t)=>{let n=e.filter(e=>t[e].enabled).map(e=>({...Qc(e),enabled:!0,activeParams:t[e].activeParams}));s.setEffectsChain(n)};(0,_.useEffect)(()=>{let e=(async()=>{re(l,d);let e=o.onError;o.onError=e=>{T(e),setTimeout(()=>T(null),6e3)};try{let e=Yc[0];await o.setProceduralSource(c,e.id)}catch(e){console.warn(`Could not initialize procedural source:`,e)}return C(!0),()=>{o.onError=e}})();return()=>{k.current&&clearInterval(k.current),O.current&&!O.current.closed&&O.current.close(),o.dispose(),s.dispose(),c.dispose(),e.then(e=>{e&&e()})}},[]);let ie=()=>{let e=!M;ne(e),s.setGlobalPalette(N,e),e||re(l,d)},ae=e=>{P(e),s.setGlobalPalette(e,M)},oe=e=>{let t=!d[e]?.enabled;m(n=>({...n,[e]:t})),u(n=>{if(n.indexOf(e)===-1)return n;let r=n.filter(t=>t!==e);if(t){let t=r.findIndex(e=>!d[e]?.enabled),n=t===-1?r.length:t;r.splice(n,0,e)}else{let t=r.map((e,t)=>d[e]?.enabled?t:-1).filter(e=>e!==-1),n=t.length>0?t[t.length-1]+1:0;r.splice(n,0,e)}let i=r;return f(n=>{let r={...n,[e]:{...n[e],enabled:t}};return re(i,r),r}),i})},se=e=>{m(t=>({...t,[e]:!t[e]}))},F=(e,t)=>{u(n=>{let r=n.indexOf(e);if(r===-1||t===`up`&&r===0||t===`down`&&r===n.length-1)return n;let i=[...n],a=t===`up`?r-1:r+1;return[i[r],i[a]]=[i[a],i[r]],f(e=>(re(i,e),e)),i})},ce=(e,t,n)=>{f(r=>{let i={...r[e].activeParams,[t]:n},a={...r,[e]:{...r[e],activeParams:i}};return s.updateEffectParam(e,t,n),re(l,a),a})},le=(e,t)=>{g(e),y(t),x(e===`camera`||e===`video`),D(!1),T(null)},ue=async e=>{try{await o.setProceduralSource(c,e),le(`procedural`,`Procedural: ${Yc.find(t=>t.id===e)?.label||e}`)}catch(e){console.warn(`Error setting procedural source:`,e)}},de=()=>{x(o.togglePlayback())},fe=()=>{if(O.current&&!O.current.closed)O.current.close(),O.current=null,j(!1);else{let e=window.open(``,`DeepPixel Output`,`width=1280,height=720,toolbar=no,menubar=no,location=no,personalbar=no,status=no,titlebar=no,scrollbars=no,resizable=yes`);if(!e){T(`El navegador bloqueó la ventana emergente. Permite popups para DeepPixel.`);return}try{e.moveTo(0,0),e.resizeTo(screen.availWidth,screen.availHeight),e.focus()}catch{}e.document.write(`<!DOCTYPE html>
<html>
<head>
...
</html>`),e.document.close(),O.current=e,j(!0),k.current&&clearInterval(k.current);let t=setInterval(()=>{e.closed&&(clearInterval(t),k.current=null,O.current=null,j(!1))},1e3);k.current=t}},pe=e=>{let t=O.current;if(!t||t.closed)return;let n=performance.now();if(!(n-ee.current<33)){ee.current=n;try{let n=e,r=e.width,i=e.height;if(r>640||i>480){te.current||=document.createElement(`canvas`);let t=Math.round(r/2),a=Math.round(i/2);te.current.width=t,te.current.height=a,te.current.getContext(`2d`).drawImage(e,0,0,t,a),n=te.current}createImageBitmap(n).then(e=>{t.closed?e.close():t.postMessage({_type:`frame`,bitmap:e},`*`,[e])}).catch(()=>{})}catch{}}},me=async()=>{try{await o.setCamera(),le(`camera`,`Cámara Web`)}catch{}},he=async e=>{let t=e.target.files[0];t&&(t.type.startsWith(`image/`)?(await o.setImage(t),le(`image`,t.name)):t.type.startsWith(`video/`)?(await o.setVideo(t),le(`video`,t.name)):alert(`Formato no soportado.`))},ge=()=>{if(!s.renderer)return;let e=s.renderer.domElement;if(!e)return;let t=e.toDataURL(`image/png`),n=document.createElement(`a`);n.href=t,n.download=`deeppixel-${Date.now()}.png`,n.click()},_e=()=>{if(!s.renderer)return;let e=s.renderer.domElement;if(e)try{let t=Vc.exportSVG(e,{}),n=new Blob([t],{type:`image/svg+xml`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`deeppixel-vector-${Date.now()}.svg`,i.click(),URL.revokeObjectURL(r)}catch(e){console.error(`SVG export error:`,e)}},ve=()=>{let e=l.filter(e=>d[e]?.enabled).map(e=>({id:e,params:d[e].activeParams}))[0];if(!e)return;let t={version:`1.0`,timestamp:Date.now(),preset:{effectId:e.id,params:e.params}},n=new Blob([JSON.stringify(t,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`deeppixel-preset-${Date.now()}.json`,i.click(),URL.revokeObjectURL(r)},ye=(e,t)=>{f(n=>{let r={...n,[e]:{enabled:!0,activeParams:t}};return Object.keys(t).forEach(n=>s.updateEffectParam(e,n,t[n])),re(l,r),r}),m(t=>({...t,[e]:!0}))},be=e=>{let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target.result);t.version&&t.preset?ye(t.preset.effectId,t.preset.params):alert(`Formato de preset inválido.`)}catch{alert(`Error al leer el preset.`)}},n.readAsText(t)},xe=l.filter(e=>d[e]?.enabled).map(e=>({id:e,params:d[e].activeParams}))[0];return S?e?(0,X.jsx)(`div`,{className:`output-mode-fullscreen`,children:(0,X.jsx)(Wc,{inputManager:o,pipeline:s,isVideoPlaying:b,onTogglePlay:de,onOutputFrame:pe,showOverlays:!1})}):(0,X.jsxs)(X.Fragment,{children:[(0,X.jsxs)(`header`,{className:`app-header-vj`,children:[(0,X.jsx)(`div`,{className:`header-logo`,children:`DEEPPIXEL`}),(0,X.jsxs)(`div`,{className:`header-controls`,children:[(0,X.jsx)(`span`,{className:`header-section-label`,children:`FUENTE`}),(0,X.jsxs)(`div`,{className:`header-source-row`,children:[(0,X.jsx)(`button`,{className:`hbtn`,onClick:me,"data-active":h===`camera`,children:`◉ CÁMARA`}),(0,X.jsx)(`button`,{className:`hbtn`,onClick:()=>i.current?.click(),children:`⤒ SUBIR`}),(0,X.jsx)(`input`,{ref:i,type:`file`,accept:`image/*,video/*`,className:`hidden-file-input`,onChange:he}),(0,X.jsx)(`span`,{className:`header-divider`}),Yc.map(e=>(0,X.jsxs)(`button`,{className:`hbtn hbtn-proc ${h===`procedural`&&o.proceduralSource?.type===e.id?`active`:``}`,onClick:()=>ue(e.id),title:e.description,children:[e.label===`Barras de Prueba`?`▦`:e.label===`Textura CRT`?`≡`:`◎`,` `,e.label===`Barras de Prueba`?`BARRAS`:e.label===`Textura CRT`?`CRT`:`MOIRÉ`]},e.id))]}),(0,X.jsx)(`span`,{className:`header-section-label`,children:`PALETA`}),(0,X.jsx)(`div`,{className:`header-global-palette`,children:(0,X.jsx)(`button`,{className:`hbtn ${M?`active`:``}`,onClick:ie,title:`Activar paleta global — unifica todos los efectos bajo una misma paleta`,children:M?`◉ GLOBAL`:`◯ GLOBAL`})}),(0,X.jsx)(`span`,{className:`header-section-label`,children:`EXPORT`}),(0,X.jsxs)(`div`,{className:`header-export-row`,children:[(0,X.jsx)(`button`,{className:`hbtn`,onClick:ge,title:`Exportar PNG`,children:`⬇ PNG`}),xe&&(0,X.jsx)(`button`,{className:`hbtn`,onClick:_e,title:`Exportar SVG`,children:`⬇ SVG`}),(0,X.jsx)(`span`,{className:`header-divider`}),(0,X.jsx)(`button`,{className:`hbtn`,onClick:ve,title:`Exportar preset JSON`,children:`☰ PRESET`}),(0,X.jsx)(`button`,{className:`hbtn`,onClick:()=>a.current?.click(),title:`Importar preset JSON`,children:`☷ IMP.`}),(0,X.jsx)(`input`,{ref:a,type:`file`,accept:`.json`,className:`hidden-file-input`,onChange:be}),(0,X.jsx)(`span`,{className:`header-divider`}),(0,X.jsx)(`button`,{className:`hbtn ${A?`active`:``}`,onClick:fe,title:`Ventana de output — abre una ventana separada con solo el canvas`,children:A?`◉ OUTPUT`:`◇ OUTPUT`})]})]}),(0,X.jsxs)(`div`,{className:`header-status-vj`,children:[(0,X.jsx)(`span`,{className:`status-led ${h===`none`?`red`:`orange`}`}),(0,X.jsx)(`span`,{className:`header-source-label`,children:v.toUpperCase()})]})]}),(0,X.jsxs)(`main`,{className:`app-container-vj`,children:[(0,X.jsxs)(`aside`,{className:`sidebar-vj`,children:[(0,X.jsxs)(`div`,{className:`sidebar-header-vj`,children:[(0,X.jsx)(`span`,{className:`sidebar-title`,children:`CADENA DE EFECTOS`}),(0,X.jsxs)(`span`,{className:`sidebar-count`,children:[l.filter(e=>d[e]?.enabled).length,`/`,l.length]}),(0,X.jsxs)(`div`,{className:`sidebar-actions`,children:[(0,X.jsx)(`button`,{className:`sidebar-btn`,onClick:()=>{let e={};Zc.forEach(t=>{e[t.id]=!0}),m(e)},children:`[+]`}),(0,X.jsx)(`button`,{className:`sidebar-btn`,onClick:()=>m({}),children:`[−]`})]})]}),(0,X.jsx)(`div`,{className:`sidebar-effects`,children:(0,X.jsx)(Jc,{effectsChain:d,effectOrder:l,expandedEffects:p,onToggleEffect:oe,onToggleExpand:se,onMoveEffect:F,onParamChange:ce,onExtractPalette:(e,t)=>{let n=o.getTexture();if(!n)return;let r=n.image||n;if(r instanceof HTMLCanvasElement||r instanceof HTMLImageElement||r instanceof HTMLVideoElement){let n=Kc(r,8);n&&ce(e,t,n)}else if(!(r instanceof HTMLCanvasElement)&&n.source?.data)try{let r=document.createElement(`canvas`);r.width=n.source.data.width||64,r.height=n.source.data.height||64;let i=r.getContext(`2d`),a=new ImageData(new Uint8ClampedArray(n.source.data),r.width,r.height);i.putImageData(a,0,0);let o=Kc(r,8);o&&ce(e,t,o)}catch(e){console.warn(`Could not extract palette from data texture`,e)}},getEffectById:Qc,onCollapseAll:()=>m({}),onExpandAll:()=>{let e={};Zc.forEach(t=>{e[t.id]=!0}),m(e)},globalPalette:N,useGlobalPalette:M,onGlobalPaletteChange:ae})})]}),(0,X.jsx)(`section`,{className:`viewport-vj`,children:(0,X.jsx)(Wc,{inputManager:o,pipeline:s,isVideoPlaying:b,onTogglePlay:de,onOutputFrame:pe})})]}),w&&(0,X.jsxs)(`div`,{className:`error-toast`,onClick:()=>T(null),children:[(0,X.jsx)(`span`,{className:`error-toast-icon`,children:`⚠`}),(0,X.jsx)(`span`,{children:w})]}),E&&(0,X.jsx)(`div`,{className:`welcome-hint`,children:(0,X.jsx)(`span`,{children:`Elegí un generador VJ, subí video, o activá la cámara para empezar`})})]}):(0,X.jsx)(`div`,{style:{height:`100vh`,width:`100vw`,backgroundColor:`#111112`,display:`flex`,justifyContent:`center`,alignItems:`center`,fontFamily:`var(--font-mono)`,color:`#ff6b00`,textTransform:`uppercase`,letterSpacing:`0.2em`},children:`[ Inicializando DeepPixel... ]`})}(0,v.createRoot)(document.getElementById(`root`)).render((0,X.jsx)(_.StrictMode,{children:(0,X.jsx)(el,{})}));